...
public enum ErrorCode {
    ...
    DISTRIBUTED_LOCK_FAILED(HttpStatus.CONFLICT, "P004", "요청이 몰려 처리에 실패했습니다. 잠시 후 다시 시도해주세요."),
    ...
    ORDER_REQUEST_IN_PROGRESS(HttpStatus.CONFLICT, "O001", "동일한 주문 요청이 처리 중입니다."),
    IDEMPOTENCY_KEY_CONFLICT(HttpStatus.CONFLICT, "O002", "이미 다른 요청에 사용된 idempotency key입니다."),
